...
var file_product_proto_rawDesc = []byte{
	...
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x32, 0xd7, 0x01, 0x0a, 0x0e, 0x50,
...
var file_product_proto_depIdxs = []int32{
	...
	0, // 3: product.ProductService.Product:input_type -> product.ProductItemRequest
	1, // 4: product.ProductService.Products:input_type -> product.ProductRequest
	3, // 5: product.ProductService.ProductList:input_type -> product.ProductListRequest
	5, // 6: product.ProductService.Product:output_type -> product.ProductItem
	2, // 7: product.ProductService.Products:output_type -> product.ProductResponse
	4, // 8: product.ProductService.ProductList:output_type -> product.ProductListResponse
